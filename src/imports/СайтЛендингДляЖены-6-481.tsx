import svgPaths from "./svg-c09rfmr803";
...
function GratitudeStory3() {
  return (
    <div className="absolute h-[29.998px] left-0 top-0 w-[297.112px]" data-name="GratitudeStory">
      <p className="absolute font-['Montserrat:Medium',_sans-serif] font-medium leading-[30px] left-0 text-[20px] text-black text-nowrap top-[0.14px] tracking-[-0.4492px] whitespace-pre">Ты любишь</p>
    </div>
  );
}
...
function Frame10() {
  return (
    <div className="content-stretch flex gap-[8px] items-start relative shrink-0 w-full">
      ...
      <div className="aspect-[100/100] basis-0 grow min-h-px min-w-px relative rounded-[8px] shrink-0">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none rounded-[8px] size-full" src={imgContainer} />
      </div>
    </div>
  );
}
