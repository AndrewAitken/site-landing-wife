      ...
      <div className="relative shrink-0 w-full">
        <div className="flex flex-col items-center size-full">
          <div className="box-border content-stretch flex flex-col gap-[16px] items-center p-[24px] relative w-full">
            <p className="font-['Montserrat:Regular',_sans-serif] font-normal leading-[56px] relative shrink-0 text-[56px] text-center text-neutral-950 text-nowrap tracking-[0.123px] whitespace-pre">30 лет</p>
